...
data_abl1 = load('prediction_all_samples_ftgc.mat');        % Ablation 1
data_abl2 = load('prediction_all_samples_ftgt.mat');        % Ablation 2
data_abl3 = load('prediction_all_samples_fxtgc.mat');       % Ablation 3
...
for idx = 1:18
    ...
    rmse_all(1, idx) = mean(abs(y_pred_mean - y_true_test));
    ...
    rmse_all(2, idx) = mean(abs(abl1_mean_test - y_true_test));
    ...
    rmse_all(3, idx) = mean(abs(abl2_mean_test - y_true_test));
    ...
    rmse_all(4, idx) = mean(abs(abl3_mean_test - y_true_test));
...
ylabel('Absolute error', 'FontName', fontName, 'FontSize', font_size);
